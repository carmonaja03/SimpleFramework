Feature: Simple test
  ...
  @youtubeTest
  Scenario: User clicks side menu
    Given user goes to youtube website
    And user clicks "Explore" side menu
    And user clicks "Music" explore section
    Then user validates that "Music" channel is displayed